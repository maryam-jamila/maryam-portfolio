-- ================================================================
-- MARYAM JAMILA PORTFOLIO — INITIAL DATA SEED
-- Run AFTER backend/supabase.sql.
-- This replaces ONLY the portfolio_content.main record.
-- It does not delete contact messages or storage files.
-- ================================================================
...
values (
  ...
  "skills": {
    "Graphic Design": [
      {
        "name": "Graphic Design",
        "description": "Visual design across print and digital, built around clarity and intent."
      },
      {
        "name": "Social Media Design",
        "description": "Scroll-stopping visual content built for platform and audience."
      }
    ],
    "Branding": [
      {
        "name": "Brand Identity Design",
        "description": "Cohesive visual systems that give a brand a consistent voice."
      },
      {
        "name": "Logo Design",
        "description": "Distinct marks distilled from a brand''s story into a single symbol."
      }
    ],
    "UI/UX": [
      {
        "name": "UI/UX Design",
        "description": "Interfaces shaped by how people actually think, move, and decide."
      }
    ],
    "Software Development": [
      {
        "name": "Front-End / Application Development",
        "description": "Turning interfaces and concepts into working, responsive software."
      }
    ],
    "AI": [
      {
        "name": "AI-Powered Application Development",
        "description": "Integrating intelligent models into practical, purpose-built tools."
      }
    ],
    "Professional Skills": [
      {
        "name": "Creative Problem Solving",
        "description": "Approaching technical and visual challenges from unexpected angles."
      },
      {
        "name": "Communication",
        "description": ""
  ...
  "projects": [
    ...
    },
    {
      "id": "faculty-app",
      "category": "UI/UX & Applications",
      "title": "Faculty Information Management App",
    ...
    },
    {
      ...
      "title": "VegCross — AI-Based Vegetable Breeding Application",
      ...
      "role": "AI Integration & App Development",
      "tools": [],
      "images": [],
      "featured": true
    },
    {
      ...
      "title": "CodeCelix — Graphic Designer Intern",
    ...
    },
    {
      "id": "eliteedge",
      "category": "Internship Work",
      "title": "Elite Edge Outsourcing — Graphic Designer Intern",
